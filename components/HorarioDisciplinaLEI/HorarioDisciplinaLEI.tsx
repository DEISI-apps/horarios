...
import { useDisciplinasAnoSemestreLEI } from "@/hooks/useDisciplinasAnoSemestreLEI";
import CalendarioSemanalDisciplina from "../CalendarioSemanalDisciplina";
import { Loader2 } from "lucide-react";


export default function HorarioDisciplinaLEI() {
  ...
  const { disciplinas, isLoadingDisciplinas } = useDisciplinasAnoSemestreLEI(selectedAnoLectivo, selectedSemestre);
